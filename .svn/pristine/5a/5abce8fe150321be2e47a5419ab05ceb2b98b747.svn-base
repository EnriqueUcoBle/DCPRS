...
Partial Class Cat_Estudios
    ...
    Private Sub InitializeComponent()
        ...
        Me.DGVECLAVE = New Wisej.Web.DataGridViewTextBoxColumn()
        Me.DGVEESTUDIO = New Wisej.Web.DataGridViewTextBoxColumn()
        Me.DGVEDESCRIPCIONX = New Wisej.Web.DataGridViewTextBoxColumn()
        Me.DGVECLAVEMUESTRA = New Wisej.Web.DataGridViewTextBoxColumn()
        Me.DGVEMUESTRA = New Wisej.Web.DataGridViewTextBoxColumn()
        Me.DGVEDESCRIPCIONY = New Wisej.Web.DataGridViewTextBoxColumn()
        Me.DGVEOPERADOR = New Wisej.Web.DataGridViewTextBoxColumn()
        Me.BindingSource1 = New Wisej.Web.BindingSource(Me.components)
        Me.DataSet_pCAT_ESTUDIOS_B = New DPCRS.DataSet_pCAT_ESTUDIOS_B()
        ...
        Me.TXTEstudio = New Wisej.Web.TextBox()
        ...
        CType(Me.DataSet_pCAT_ESTUDIOS_B, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.DGVEstudios.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle3
        Me.DGVEstudios.ColumnHeadersHeightSizeMode = Wisej.Web.DataGridViewColumnHeadersHeightSizeMode.AutoSize
        Me.DGVEstudios.Columns.AddRange(New Wisej.Web.DataGridViewColumn() {Me.Eliminar, Me.DGVECLAVE, Me.DGVEESTUDIO, Me.DGVEDESCRIPCIONX, Me.DGVECLAVEMUESTRA, Me.DGVEMUESTRA, Me.DGVEDESCRIPCIONY, Me.DGVEOPERADOR})
        Me.DGVEstudios.DataSource = Me.BindingSource1
        Me.DGVEstudios.Dock = Wisej.Web.DockStyle.Fill
        Me.DGVEstudios.Location = New System.Drawing.Point(0, 266)
        Me.DGVEstudios.Name = "DGVEstudios"
        Me.DGVEstudios.RowHeadersVisible = False
        Me.DGVEstudios.Size = New System.Drawing.Size(842, 209)
        ...
        'DGVECLAVE
        '
        Me.DGVECLAVE.DataPropertyName = "CVE_ESTUDIO"
        Me.DGVECLAVE.HeaderText = "Clave"
        Me.DGVECLAVE.Name = "DGVECLAVE"
        Me.DGVECLAVE.ReadOnly = True
        Me.DGVECLAVE.SortMode = Wisej.Web.DataGridViewColumnSortMode.NotSortable
        Me.DGVECLAVE.ValueType = GetType(String)
        '
        'DGVEESTUDIO
        '
        Me.DGVEESTUDIO.DataPropertyName = "ESTUDIO"
        Me.DGVEESTUDIO.HeaderText = "Estudio"
        Me.DGVEESTUDIO.Name = "DGVEESTUDIO"
        Me.DGVEESTUDIO.ReadOnly = True
        Me.DGVEESTUDIO.SortMode = Wisej.Web.DataGridViewColumnSortMode.NotSortable
        Me.DGVEESTUDIO.ValueType = GetType(String)
        Me.DGVEESTUDIO.Width = 300
        '
        'DGVEDESCRIPCIONX
        '
        Me.DGVEDESCRIPCIONX.DataPropertyName = "DESCRIPCIONX"
        Me.DGVEDESCRIPCIONX.HeaderText = "DESCRIPCIONX"
        Me.DGVEDESCRIPCIONX.Name = "DGVEDESCRIPCIONX"
        Me.DGVEDESCRIPCIONX.ReadOnly = True
        Me.DGVEDESCRIPCIONX.SortMode = Wisej.Web.DataGridViewColumnSortMode.NotSortable
        Me.DGVEDESCRIPCIONX.ValueType = GetType(String)
        Me.DGVEDESCRIPCIONX.Visible = False
        '
        'DGVECLAVEMUESTRA
        '
        Me.DGVECLAVEMUESTRA.DataPropertyName = "CVE_MUESTRA"
        Me.DGVECLAVEMUESTRA.HeaderText = "CLAVEMUESTRA"
        Me.DGVECLAVEMUESTRA.Name = "DGVECLAVEMUESTRA"
        Me.DGVECLAVEMUESTRA.ReadOnly = True
        Me.DGVECLAVEMUESTRA.SortMode = Wisej.Web.DataGridViewColumnSortMode.NotSortable
        Me.DGVECLAVEMUESTRA.ValueType = GetType(Integer)
        Me.DGVECLAVEMUESTRA.Visible = False
        '
        'DGVEMUESTRA
        '
        Me.DGVEMUESTRA.DataPropertyName = "MUESTRA"
        Me.DGVEMUESTRA.HeaderText = "Muestra"
        Me.DGVEMUESTRA.Name = "DGVEMUESTRA"
        Me.DGVEMUESTRA.ReadOnly = True
        Me.DGVEMUESTRA.SortMode = Wisej.Web.DataGridViewColumnSortMode.NotSortable
        Me.DGVEMUESTRA.ValueType = GetType(String)
        Me.DGVEMUESTRA.Width = 300
        '
        'DGVEDESCRIPCIONY
        '
        Me.DGVEDESCRIPCIONY.DataPropertyName = "DESCRIPCIONY"
        Me.DGVEDESCRIPCIONY.HeaderText = "DESCRIPCIONY"
        Me.DGVEDESCRIPCIONY.Name = "DGVEDESCRIPCIONY"
        Me.DGVEDESCRIPCIONY.ReadOnly = True
        Me.DGVEDESCRIPCIONY.SortMode = Wisej.Web.DataGridViewColumnSortMode.NotSortable
        Me.DGVEDESCRIPCIONY.ValueType = GetType(String)
        Me.DGVEDESCRIPCIONY.Visible = False
        '
        'DGVEOPERADOR
        '
        Me.DGVEOPERADOR.DataPropertyName = "CVE_OPERADOR"
        Me.DGVEOPERADOR.HeaderText = "Operador"
        Me.DGVEOPERADOR.Name = "DGVEOPERADOR"
        Me.DGVEOPERADOR.ValueType = GetType(String)
        '
        'BindingSource1
        '
        Me.BindingSource1.DataMember = "pCAT_ESTUDIOS_B"
        Me.BindingSource1.DataSource = Me.DataSet_pCAT_ESTUDIOS_B
        '
        'DataSet_pCAT_ESTUDIOS_B
        '
        Me.DataSet_pCAT_ESTUDIOS_B.DataSetName = "DataSet_pCAT_ESTUDIOS_B"
        Me.DataSet_pCAT_ESTUDIOS_B.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema
        '
        'DGVDESCRIPCIONX
        '
        ...
        Me.DGVDESCRIPCIONX.ValueType = GetType(String)
        ...
        Me.DGVDESCRIPCIONY.ValueType = GetType(String)
        ...
        Me.CLAVE.ValueType = GetType(String)
        '
        'ESTADO
        '
        ...
        Me.ESTADO.ValueType = GetType(String)
        Me.ESTADO.Width = 300
        '
        'RibbonBar1
        '
        ...
        Me.RibbonBar1.Size = New System.Drawing.Size(842, 145)
        '
        'Menu
        '
        ...
        Me.FiltroGrillaSax1.Size = New System.Drawing.Size(842, 40)
        Me.FiltroGrillaSax1.TabIndex = 2
        '
        'RBHabilitado
        '
        Me.RBHabilitado.Checked = True
        Me.RBHabilitado.Location = New System.Drawing.Point(613, 6)
        ...
        'RBDesactivado
        '
        Me.RBDesactivado.Location = New System.Drawing.Point(720, 6)
        ...
        'TXTEstudio
        '
        Me.TXTEstudio.Location = New System.Drawing.Point(270, 24)
        Me.TXTEstudio.Name = "TXTEstudio"
        Me.TXTEstudio.Size = New System.Drawing.Size(234, 22)
        Me.TXTEstudio.TabIndex = 1
        '
        'TXTClave
        '
        Me.TXTClave.Enabled = False
        Me.TXTClave.Location = New System.Drawing.Point(110, 24)
        ...
        Me.Label1.Text = "Clave Estudio"
        '
        'Panel1
        '
        Me.Panel1.AutoScroll = True
        Me.Panel1.Controls.Add(Me.CBSMuestra)
        Me.Panel1.Controls.Add(Me.Label3)
        Me.Panel1.Controls.Add(Me.Label2)
        Me.Panel1.Controls.Add(Me.TXTEstudio)
        ...
        Me.Panel1.Size = New System.Drawing.Size(842, 81)
        ...
        Me.CBSMuestra.Location = New System.Drawing.Point(574, 22)
        Me.CBSMuestra.Name = "CBSMuestra"
        Me.CBSMuestra.Size = New System.Drawing.Size(300, 22)
        Me.CBSMuestra.TabIndex = 2
        ComponentTool2.ImageSource = "icon-close"
        ComponentTool2.Name = "Borrar"
        Me.CBSMuestra.Tools.AddRange(New Wisej.Web.ComponentTool() {ComponentTool2})
        Me.CBSMuestra.Watermark = "Ingrese Texto (Enter)..."
        '
        'Label3
        '
        Me.Label3.AutoSize = True
        Me.Label3.Location = New System.Drawing.Point(517, 27)
        ...
        Me.BindingNavigator1.Location = New System.Drawing.Point(0, 475)
        ...
        Me.BindingNavigator1.Size = New System.Drawing.Size(842, 34)
        ...
        Me.Name = "Cat_Estudios"
        Me.Text = "Cat Estudios"
        ...
        CType(Me.DataSet_pCAT_ESTUDIOS_B, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents DataSet_pCAT_ESTUDIOS_B As DataSet_pCAT_ESTUDIOS_B
    ...
    Private WithEvents DGVECLAVE As DataGridViewTextBoxColumn
    Private WithEvents DGVEESTUDIO As DataGridViewTextBoxColumn
    Private WithEvents DGVEDESCRIPCIONX As DataGridViewTextBoxColumn
    Private WithEvents DGVEMUESTRA As DataGridViewTextBoxColumn
    Private WithEvents DGVEOPERADOR As DataGridViewTextBoxColumn
    Private WithEvents DGVEDESCRIPCIONY As DataGridViewTextBoxColumn
    Private WithEvents DGVECLAVEMUESTRA As DataGridViewTextBoxColumn
