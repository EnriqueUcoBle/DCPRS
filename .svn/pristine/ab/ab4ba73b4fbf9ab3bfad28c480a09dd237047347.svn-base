...
Public Class Add_Tipo_Analisis
    ...
    Private Function GUARDAR_() As Boolean
        If validar() Then
            Try
                ...
                oFunciones.ParametersX_Global(0) = New SqlClient.SqlParameter("@CVE_TIPO_ANALISIS", CVE_TIPO_MUESTRA.Text)
                ...
                Dim result = oFunciones.fGuardar_O_EliminarXProcedure_DevuelveId("pCAT_TIPO_ANALISIS_G", "@PARAM", oFunciones.ParametersX_Global, False, SqlDbType.Int)
                If result = Nothing Then
                    ...
                    Return False
                Else
                    Wisej.Web.MessageBox.Show("Tipo de analisis Guardado Correctamente", "Guardar", Wisej.Web.MessageBoxButtons.OK, Wisej.Web.MessageBoxIcon.Information)
                    Return True
                End If
    ...
    Private Function validar() As Boolean
        ...
        If NOMBRE.Text.Length = 0 Then
            ...
            cont = cont + 1
        ElseIf DESCRIPCION.Text.Length = 0 Then
